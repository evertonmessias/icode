<?php
if (!is_front_page() && !is_user_logged_in()) wp_redirect("/wp-admin");
?>
...
$post_color = get_option('portal_input_1');
  ...
  <div id="topbar" <?php if (is_user_logged_in()) echo "style='margin-top:30px;'"; ?> class="d-none d-lg-flex align-items-center fixed-top">
    <div class="container d-flex">
      ...
      <div class="contact-info mr-auto">
        <?php if (get_option('portal_input_9') != "") { ?>
          <i class="icofont-envelope"></i>&ensp;<a href="mailto:<?php echo get_option('portal_input_9'); ?>"><?php echo get_option('portal_input_9'); ?></a>
        <?php } ?>
        &emsp;
        <?php if (get_option('portal_input_8') != "") { ?>
          <i class="bx bxl-whatsapp"></i>&ensp;<a target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo get_option('portal_input_8'); ?>&text=icode"><?php echo get_option('portal_input_8'); ?></a>
        <?php } ?>
      </div>
      ...
      ?>
          <div class="search">
            <form action="/" method="get">
              <input type="text" placeholder="Pesquisar PDFs" required name="s" id="search" value="<?php the_search_query(); ?>" />
              <input type="hidden" name="t" value="pdf">              
        ...
        <?php } else { ?>
          ...
          <div class="search">
            <form action="/<?php echo url_active()[1]; ?>/" method="get">
              <input type="text" placeholder="Pesquisar Posts" required name="s" id="search" value="<?php the_search_query(); ?>" />
  ...
  <header id="header" <?php if (is_user_logged_in()) echo "style='margin-top:30px;'"; ?> class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        ...
        <ul>
          <li id="about"><a href="/#About">Inicio</a></li>
          <?php if (is_user_logged_in()) { ?>
