...
*/
	 ...
	 */
	static private function api_request($api_url = false, $args = array(), $cache_time = 0, &$output)
	{
		if($api_url) 
		{
	 ...
	 * @return mixed The response or false if there is an error.
	 */
	static private function remote_post($url, $params = array(), $cache_time = 0, &$output)
	{
