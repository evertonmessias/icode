...
"fixed"==a.o.compact.position)var d=setInterval(function(){"fixed"==a.n.search.css("position")&&(a.n.search.detach().appendTo("body"),a.n.trythis.detach().appendTo("body"),a.n.search.css({top:a.n.search.offset().top-b(document).scrollTop()+"px"}),clearInterval(d))},200)},_initSettingsBox:function(){if(v()&&1==this.o.mobile.force_sett_hover)return this.n.searchsettings.attr("id",this.n.searchsettings.attr("id").replace("probsettings","prosettings")),this.n.searchsettings.removeClass("asp_sb asp_sb_"+
this.o.id+" asp_sb_"+this.o.rid),this.n.searchsettings.addClass("asp_s asp_s_"+this.o.id+" asp_s_"+this.o.rid),this.n.searchsettings.detach().appendTo("body"),this.n.searchsettings.css({position:"absolute"}),this.o.blocking=!1,this.detectAndFixFixedPositioning(),!0;0<this.n.settingsAppend.length?0<this.n.settingsAppend.find(".asp_w").length?this.n.searchsettings=this.n.settingsAppend.find(".asp_w"):(0==this.o.blocking&&(this.n.searchsettings.attr("id",this.n.searchsettings.attr("id").replace("prosettings",
"probsettings")),this.o.blocking=!0),this.n.searchsettings.detach().appendTo(this.n.settingsAppend)):0==this.o.blocking&&this.n.searchsettings.detach().appendTo("body")},initSettingsBox:function(){var a=this,d=function(c){var f=a.n.searchsettings.get(0);a.n.searchsettings=a.n.searchsettings.clone();c.append(a.n.searchsettings);b(f).find("*[id]").each(function(){0>this.id.indexOf("__original__")&&(this.id="__original__"+this.id)});a.n.searchsettings.find("*[id]").each(function(){-1<this.id.indexOf("__original__")&&
(this.id=this.id.replace("__original__",""))})};1==a.o.compact.enabled&&"fixed"==a.o.compact.position||v()&&1==a.o.mobile.force_sett_hover?(a.n.searchsettings.attr("id",a.n.searchsettings.attr("id").replace("probsettings","prosettings")),a.n.searchsettings.removeClass("asp_sb asp_sb_"+a.o.id+" asp_sb_"+a.o.rid).addClass("asp_s asp_s_"+a.o.id+" asp_s_"+a.o.rid),a.o.blocking=!1,d(b("body")),a.n.searchsettings.css({position:"absolute"}),a.o.blocking=!1,a.detectAndFixFixedPositioning()):0<a.n.settingsAppend.length?
0<a.n.settingsAppend.find(".asp_w").length?a.n.searchsettings=a.n.settingsAppend.find(".asp_w"):(0==a.o.blocking&&(a.n.searchsettings.attr("id",a.n.searchsettings.attr("id").replace("prosettings","probsettings")),a.n.searchsettings.removeClass("asp_s asp_s_"+a.o.id+" asp_s_"+a.o.rid).addClass("asp_sb asp_sb_"+a.o.id+" asp_sb_"+a.o.rid),a.o.blocking=!0),d(a.n.settingsAppend)):0==a.o.blocking&&d(b("body"));a.n.searchsettings.get(0).id=a.n.searchsettings.get(0).id.replace("__original__","")},_initResultsBox:function(){v()&&
1==this.o.mobile.force_res_hover?(this.o.resultsposition="hover",this.n.resultsDiv.detach().appendTo("body"),this.n.resultsDiv.css({position:"absolute"}),this.detectAndFixFixedPositioning()):"hover"==this.o.resultsposition&&0>=this.n.resultsAppend.length?this.n.resultsDiv.detach().appendTo("body"):(this.o.resultsposition="block",this.n.resultsDiv.css({position:"static"}),0<this.n.resultsAppend.length?0<this.n.resultsAppend.find(".asp_w").length?(this.n.resultsDiv=this.n.resultsAppend.find(".asp_w"),
this.n.showmore=b(".showmore",this.n.resultsDiv),this.n.items=0<b(".item",this.n.resultsDiv).length?b(".item",this.n.resultsDiv):b(".photostack-flip",this.n.resultsDiv),this.n.results=b(".results",this.n.resultsDiv),this.n.resdrg=b(".resdrg",this.n.resultsDiv)):this.n.resultsDiv.detach().appendTo(this.n.resultsAppend):this.n.resultsDiv.detach().insertAfter(this.n.search))},initResultsBox:function(){v()&&1==this.o.mobile.force_res_hover?(this.o.resultsposition="hover",this.n.resultsDiv=this.n.resultsDiv.clone(),
b("body").append(this.n.resultsDiv),this.n.resultsDiv.css({position:"absolute"}),this.detectAndFixFixedPositioning()):"hover"==this.o.resultsposition&&0>=this.n.resultsAppend.length?(this.n.resultsDiv=this.n.resultsDiv.clone(),b("body").append(this.n.resultsDiv)):(this.o.resultsposition="block",this.n.resultsDiv.css({position:"static"}),0<this.n.resultsAppend.length&&(0<this.n.resultsAppend.find(".asp_w").length?(this.n.resultsDiv=this.n.resultsAppend.find(".asp_w"),this.n.showmore=b(".showmore",
this.n.resultsDiv),this.n.items=0<b(".item",this.n.resultsDiv).length?b(".item",this.n.resultsDiv):b(".photostack-flip",this.n.resultsDiv),this.n.results=b(".results",this.n.resultsDiv),this.n.resdrg=b(".resdrg",this.n.resultsDiv)):(this.n.resultsDiv=this.n.resultsDiv.clone(),this.n.resultsAppend.append(this.n.resultsDiv))));this.n.resultsDiv.get(0).id=this.n.resultsDiv.get(0).id.replace("__original__","")},initInfiniteScroll:function(){var a=this;if(a.o.show_more.infinite&&"polaroid"!=a.o.resultstype){var d;
b(p).add(a.n.results).on("scroll",function(){clearTimeout(d);d=setTimeout(function(){a.checkAndTriggerInfiniteScroll("window")},80)});var c;a.n.resultsDiv.on("nav_switch",function(){clearTimeout(c);c=setTimeout(function(){a.checkAndTriggerInfiniteScroll("isotopic")},800)})}},monitorTouchMove:function(){var a=this,d=b("body");a.dragging=!1;d.on("touchmove",function(){a.dragging=!0});d.on("touchstart",function(){a.dragging=!1})},duplicateCheck:function(){var a={};b("div[id*=ajaxsearchpro]").each(function(){a.hasOwnProperty(this.id)?
...
a=0>a?0:a;b("body, html").animate({scrollTop:a},{duration:300})}}},destroy:function(){var a=this;Object.keys(a.n).forEach(function(d){a.n[d].off()});a.n.searchsettings.remove();a.n.resultsDiv.remove();a.n.trythis.remove();a.n.search.remove();a.n.container.remove();a.documentEventHandlers.forEach(function(d){b(d.node).off(d.event,d.handler)})},autocomplete:function(){var a=this,d=a.n.text.val();if(""==a.n.text.val())a.n.textAutocomplete.val("");else{var c=a.n.textAutocomplete.val();if(""==c||0!=c.indexOf(d))a.n.textAutocomplete.val(""),
a.n.text.val().length>=a.o.autocomplete.trigger_charcount&&(c={action:"ajaxsearchpro_autocomplete",asid:a.o.id,sauto:a.n.text.val(),asp_inst_id:a.o.rid,options:b("form",a.n.searchsettings).serialize()},a.postAuto=b.post(ASP.ajaxurl,c,function(f){0<f.length&&(f=b("<textarea />").html(f).text(),f=f.replace(/^\s*[\r\n]/gm,""),f=f.substr(d.length),f=d+f);a.n.textAutocomplete.val(f);a.fixAutocompleteScrollLeft()}))}},autocompleteGoogleOnly:function(){var a=this,d=a.n.text.val();if(""==a.n.text.val())a.n.textAutocomplete.val("");
else{var c=a.n.textAutocomplete.val();if(""==c||0!=c.indexOf(d)){a.n.textAutocomplete.val("");var f=a.o.autocomplete.lang;b.each(["wpml_lang","polylang_lang","qtranslate_lang"],function(g,e){if(0<b('input[name="'+e+'"]',a.n.searchsettings).length&&1<b('input[name="'+e+'"]',a.n.searchsettings).val().length)return f=b('input[name="'+e+'"]',a.n.searchsettings).val(),!1});a.n.text.val().length>=a.o.autocomplete.trigger_charcount&&b.ajax({url:"https://clients1.google.com/complete/search",dataType:"jsonp",
data:{q:d,hl:f,nolabels:"t",client:"hp",ds:""},success:function(g){0<g[1].length&&(g=g[1][0][0].replace(/(<([^>]+)>)/ig,""),g=b("<textarea />").html(g).text(),g=g.substr(d.length),a.n.textAutocomplete.val(d+g),a.fixAutocompleteScrollLeft())}})}}},fixAutocompleteScrollLeft:function(){this.n.textAutocomplete.get(0).scrollLeft=this.n.text.get(0).scrollLeft},isDuplicateSearchTriggered:function(){for(var a=0;25>a;a++)if(this.o.id+"_"+a!=this.o.rid&&!1!==ASP.instances.get(this.o.id,a))return ASP.instances.get(this.o.id,
a).searching;return!1},searchAbort:function(){null!=this.post&&this.post.abort()},searchWithCheck:function(a){var d=this;"undefined"==typeof a&&(a=50);d.n.text.val().length<d.o.charcount||(d.searchAbort(),clearTimeout(d.timeouts.searchWithCheck),d.timeouts.searchWithCheck=setTimeout(function(){d.search()},a))},search:function(a,d,c,f,g){var e=this,l=!1;if(e.isDuplicateSearchTriggered())return!1;c="undefined"==typeof c?!1:c;f="undefined"==typeof f?!1:f;g="undefined"==typeof g?!1:g;var h={action:"ajaxsearchpro_search",
aspp:e.n.text.val(),asid:e.o.id,asp_inst_id:e.o.rid,options:b("form",e.n.searchsettings).serialize()};h=C("asp_search_data",h,e.o.id,e.o.iid);e.hideArrowBox();e.isAutoP||e.reportSettingsValidity()||(g||(e.showNextInvalidFacetMessage(),e.scrollToNextInvalidFacetMessage()),l=!0);e.isAutoP&&(h.autop=1,e.isAutoP=!1);if(!c&&!f&&JSON.stringify(h)===JSON.stringify(e.lastSearchData)){e.resultsOpened||e.usingLiveLoader||e.showResults();if(e.isRedirectToFirstResult())return e.doRedirectToFirstResult(),!1;l=
!0}if(l)return e.hideLoader(),e.searchAbort(),!1;e.n.s.trigger("asp_search_start",[e.o.id,e.o.iid,e.n.text.val()]);e.searching=!0;e.n.proclose.css({display:"none"});e.showLoader(c);0==e.o.blocking&&0==e.o.trigger.facet&&e.hideSettings();c?(e.call_num++,h.asp_call_num=e.call_num,e.autopStartedTheSearch&&(h.options+="&"+H(e.autopData),--h.asp_call_num)):(e.call_num=0,e.autopStartedTheSearch=!!h.autop);f=b('form[name="asp_data"]');0<f.length&&(h.asp_preview_options=f.serialize());"undefined"!=typeof a&&
!1!==a&&(h.options+="&force_count="+parseInt(a));"undefined"!=typeof d&&!1!==d&&(h.options+="&force_order="+parseInt(d));e.gaEvent("search_start");0<b(".asp_es_"+e.o.id).length?e.liveLoad(".asp_es_"+e.o.id,e.getCurrentLiveURL(),!1):e.o.resPage.useAjax?e.liveLoad(e.o.resPage.selector,e.getRedirectURL()):e.post=b.post(ASP.ajaxurl,h,function(k){e.gaPageview(e.n.text.val());e.searching=!1;k=k.replace(/^\s*[\r\n]/gm,"");var n=k.match(/!!ASPSTART_HTML!!(.*[\s\S]*)!!ASPEND_HTML!!/);k=k.match(/!!ASPSTART_DATA!!(.*[\s\S]*)!!ASPEND_DATA!!/);
if(null==n||"object"!=typeof n||"undefined"==typeof n[1])return e.hideLoader(),e.raiseError("missing_response"),!1;n=n[1];n=C("asp_search_html",n,e.o.id,e.o.iid);k=JSON.parse(k[1]);e.n.s.trigger("asp_search_end",[e.o.id,e.o.iid,e.n.text.val(),k]);e.autopStartedTheSearch&&("undefined"!=typeof h.autop?(e.autopData.not_in={},e.autopData.not_in_count=0,Array.isArray(k.results)&&k.results.forEach(function(r){"undefined"==typeof e.autopData.not_in[r.content_type]&&(e.autopData.not_in[r.content_type]=[]);
e.autopData.not_in[r.content_type].push(r.id);++e.autopData.not_in_count})):k.full_results_count+=e.autopData.not_in_count);c?(e.updateResults(n),e.results_num+=k.results_count):(e.n.resdrg.html(""),e.n.resdrg.html(n),e.results_num=k.results_count,e.o.statistics&&e.stat_addKeyword(e.o.id,e.n.text.val()));b(".asp_keyword",e.n.resdrg).on("click",function(){e.n.text.val(x(b(this).text()));e.n.textAutocomplete.val("");0!=e.o.redirectOnClick&&0!=e.o.redirectOnEnter&&1!=e.o.trigger.type||e.search()});e.n.items=
0<b(".item",e.n.resultsDiv).length?b(".item",e.n.resultsDiv):b(".photostack-flip",e.n.resultsDiv);e.gaEvent("search_end",{results_count:e.n.items.length});if(e.isRedirectToFirstResult())return e.doRedirectToFirstResult(),!1;e.hideLoader();e.showResults();e.scrollToResults();e.lastSuccesfulSearch=b("form",e.n.searchsettings).serialize()+e.n.text.val().trim();e.lastSearchData=h;e.updateInfoHeader(k.full_results_count);0<e.n.showmore.length&&(0<b("span",e.n.showmore).length&&0<k.results_count&&0<k.full_results_count-
e.results_num?(e.n.showmore.css("display","block"),b("span",e.n.showmore).html("("+(k.full_results_count-e.results_num)+")"),b("a",e.n.showmore).attr("href",""),b("a",e.n.showmore).off(),b("a",e.n.showmore).on(e.clickTouchend,function(r){r.preventDefault();r.stopImmediatePropagation();if("ajax"==e.o.show_more.action){if(e.searching)return!1;e.showMoreResLoader();e.search(!1,!1,!0)}else b(this).off(),"results_page"==e.o.show_more.action?r="?s="+m(e.n.text.val()):"woo_results_page"==e.o.show_more.action?
